								...
								<tbody>
                                    ...
                                    ?>  
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td class="form-group">
                                                <a href="index.php?page=edit_order_detail&order_id=<?php echo $row['order_id']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                                <a onclick="return confirmDel();" href="modules/orders/del_order_detail.php?order_id=<?php echo $row['order_id']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                            </td> -->
                                        </tr>
                                    <?php         
                                            }
